          ...
          <div class="dropdown is-hoverable">
            ...
            <div class="dropdown-menu" id="dropdown-menu" role="menu">
              <div class="dropdown-content">
                ...
                <a href="#" class="dropdown-item" @click="redirectToEditForm">
                  <span class="icon">
                    <i class="fas fa-edit"></i>
                  </span>
                  <span>Edit Event</span>
...
export default {
  ...
  methods: {
      ...
      editEvents() {
          ...
          this.$router.push({ name: 'EditEventForm', params: { category_slug, events_slug } })
      }
  }
}
</script> -->
          ...
          <div class="dropdown is-hoverable">
            ...
            <div class="dropdown-menu" id="dropdown-menu" role="menu">
              <div class="dropdown-content">
                ...
                <a href="#" class="dropdown-item" @click="$router.push({ name: 'EventEdit', params: { category_slug: this.$route.params.category_slug, events_slug: this.$route.params.events_slug } })">
                  <span class="icon">
                    <i class="fas fa-edit"></i>
                  </span>
                  <span>Edit Event</span>
