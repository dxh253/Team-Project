<template>
  ...
  <div class="home">
    <section class="hero is-small is-dark mb-6">
      <div class="hero-body has-text-centered mt-6">
        <h1 class="title" style="font-size: 50px">How can we help?</h1>
        <input
          class="search"
          type="text"
  ...
  <div v-show="showing">
    <div
      class="columns is-mobile is-centered is-multiline has-text-centered"
      style="margin-bottom: 2%"
    >
      <div class="column">
        <RouterLink to="">
          <button
            class="button is-large is-link is-light is-outlined"
    ...
    <div class="columns">
      ...
      <div class="column is-8 is-offset 8">
        <button
          class="button is-underlined is-link is-light is-outlined"
          @click="filterProblems"
        >
          My problems
        </button>
      </div>
  ...
  <div v-show="!showing">
    <div class="columns">
      <div class="column is-10">
        <h2 class="title is-3">
          You searched for problems containing "{{ searchValue }}"
        </h2>
      </div>
      <div class="column is-8 is-offset">
        <button
          type="button"
          class="button is-underlined is-link is-light"
          @click="filterProblems"
        >
          My problems
        </button>
    ...
    <button
      class="button"
      @click="clearSearch"
      style="margin-top: 2px; margin-bottom: 50px"
    >
      Clear search
    </button>
