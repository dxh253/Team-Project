    ...
    <div class="card">
      ...
      <div class="card-content">
        ...
        <div class="columns is-mobile is-gapless">
          ...
          <div class="column">
            <span class="icon is-small"><i class="fas fa-arrow-up" @click="upvote" :style="{ color: upColor }"></i></span>
            <span>{{ totalScore }}</span>
            <span class="icon is-small"><i class="fas fa-arrow-down" @click="downvote" :style="{ color: downColor }"></i></span>
          </div>
