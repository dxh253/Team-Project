...
urlpatterns = [
    ...
    path('comments/<int:pk>/', views.CommentDetail.as_view(), name='comment-detail'), # get comment details to display
    path('posts/<int:post_pk>/comments/', views.CommentList.as_view(), name='comment-list'), # create comment
