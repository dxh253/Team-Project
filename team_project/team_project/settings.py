...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=7),  # Change this value to your desired token lifetime
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'team.bham.22@gmail.com'
EMAIL_HOST_PASSWORD = '68nY4z!wHt2H'
EMAIL_HOST_PASSWORD = 'emnvmvbozmjoajah'
